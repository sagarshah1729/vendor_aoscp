...
custom_default_revision = "parfait-release"
custom_dependencies = "aoscp.dependencies"
org_manifest = "aoscp"  # leave empty if org is provided in manifest
org_display = "CypherOS"  # needed for displaying
